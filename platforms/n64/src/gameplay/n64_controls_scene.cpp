...
void ControlsScene::draw(bool)
{
    ...
    gDPSetTextureFilter(g_gui_dlist_head++, G_TF_POINT);
    gSPTexture(g_gui_dlist_head++, 0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON);
    ...
    print_text_centered(howtoplay_img_x + 32, howtoplay_img_y - 20, "Recommended controller");
    print_text_centered(howtoplay_img_x + 32, howtoplay_img_y - 10, "grip");

    
    print_text_centered(screen_width - howtoplay_img_x - 32, howtoplay_img_y +  0, "Controls");
    print_text_centered(screen_width - howtoplay_img_x - 32, howtoplay_img_y + 10, "Move: D-Pad/C-Buttons");
    ...
    print_text_centered(screen_width - howtoplay_img_x - 32, howtoplay_img_y + 40, "Hijack: L/R");
